...
VALUES
  ('Ronald', 'Firbank', 1, (SELECT id FROM parties WHERE name ='JS Juggernauts')),
  ('Virginia', 'Woolf', 1, (SELECT id FROM parties WHERE name ='JS Juggernauts')),
  ('Piers', 'Gaveston', 0, (SELECT id FROM parties WHERE name ='JS Juggernauts')),
  ('Charles', 'LeRoi', 1, (SELECT id FROM parties WHERE name ='Heroes of HTML')),
  ('Katherine', 'Mansfield', 1, (SELECT id FROM parties WHERE name ='Heroes of HTML')),
  ('Dora', 'Carrington', 0, (SELECT id FROM parties WHERE name ='Heroes of HTML')),
  ('Edward', 'Bellamy', 0, (SELECT id FROM parties WHERE name ='Git Gurus')),
  ('Montague', 'Summers', 1, (SELECT id FROM parties WHERE name ='Git Gurus')),
  ('Octavia', 'Butler', 1, (SELECT id FROM parties WHERE name ='JS Juggernauts')),
  ('Unica', 'Zurn', 1, NULL);
